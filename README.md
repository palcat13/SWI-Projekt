...
TODO — see [architecture-and-decisions.md](docs/architecture-and-decisions.md) for the justification.
...
TODO: specify request payload, validation rules, storage and the automated check.
